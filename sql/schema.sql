...
CREATE TABLE IF NOT EXISTS exams (
  ...
  target_fields_json TEXT DEFAULT NULL,                -- رشته‌های هدف: تجربی/ریاضی/...
  target_grades_json TEXT DEFAULT NULL,                -- پایه‌های هدف: دهم/یازدهم/دوازدهم/کنکوری
  created_at      DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
  updated_at      DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (id),
...
-- ----------------------------------------------------------
--  mock_exam_reports : تحلیل آزمون‌های آزمایشی/کنکور بیرونی
-- ----------------------------------------------------------
